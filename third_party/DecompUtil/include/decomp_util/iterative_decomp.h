 ...
 */
template <int Dim=2>
class IterativeDecomp2D : public EllipsoidDecomp2D<Dim>
{
  public:
    ///Simple constructor
    IterativeDecomp2D() {}
     ...
     */
    IterativeDecomp2D(const Vecf<Dim> &origin, const Vecf<Dim> &dim) :
        EllipsoidDecomp2D<Dim>(origin, dim) {}
    /**
...
template <int Dim=3>
class IterativeDecomp3D : public EllipsoidDecomp3D<Dim>
{
  public:
    ///Simple constructor
    IterativeDecomp3D() {}
     ...
     * @param dim The dimension of the global bounding box
     */
    IterativeDecomp3D(const Vecf<Dim> &origin, const Vecf<Dim> &dim) :
        EllipsoidDecomp3D<Dim>(origin, dim) {}
    /**
     * @brief Decomposition thread
     * @param path_raw The path to dilate
     * @param iter_num Max iteration number
